...
import { OrderHistoriesPageRoutingModule } from "./order-histories-routing.module";
...
import { OrderHistoriesPage } from "./order-histories.page";
...
@NgModule({
	imports: [
		...
		OrderHistoriesPageRoutingModule
	],
	declarations: [OrderHistoriesPage],
	exports: [],
	entryComponents: [],
	providers: [
