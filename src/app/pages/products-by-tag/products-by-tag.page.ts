...
@Component({
	...
	templateUrl: "products-by-tag.page.html",
	styleUrls: ["products-by-tag.page.scss"],
})

export class ProductsByTagPage {
	...
	pageName:string = `products-by-tag` ;
	
	/**
	* ProductsByTagPage:constructor()
	**/
	constructor(
		...
		console.log(`ProductsByTagPage`,`pageName`,this.pageName);
	}


	/**
	* ProductsByTagPage:storageInit();
	**/
	async storageInit(){
	...
	**/
	...
	/**
	* ProductsByTagPage.filterItems($event)
	* @param any $event
	**/
	...
	/**
	* ProductsByTagPage.loadMore(infiniteScroll)
	...
	**/
	...
	/**
	* ProductsByTagPage.ratingRendered()
	**/
	...
	**/
	...
	/**
	* ProductsByTagPage:ionViewDidLeave()
	**/
	ionViewDidLeave(){
	...
	**/
	...
	/**
	* ProductsByTagPage.pushWishlist(item)
	**/
	...
	/**
	* ProductsByTagPage.pushCart(item)
	**/
